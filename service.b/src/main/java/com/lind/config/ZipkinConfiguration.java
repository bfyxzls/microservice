...
@Configuration("LindZipkinConfiguration")
...
public class ZipkinConfiguration extends WebMvcConfigurerAdapter {
    ...
    @Bean
    public Reporter<Span> lindreporter() {
        return AsyncReporter.builder(sender()).build();
    }

    @Bean
    public Brave lindbrave() {
        return new Brave.Builder(zipkinProperties.getService()).reporter(lindreporter()).build();
    }
    ...
    public MySQLStatementInterceptorManagementBean mySQLStatementInterceptorManagementBean() {
        return new MySQLStatementInterceptorManagementBean(lindbrave().clientTracer());
    }
